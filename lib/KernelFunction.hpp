...
__global__ void stage4_probing(uint mismatch, uint threshold, uint seedlen,
...
__global__ void stage4_probing2(uint mismatch, uint threshold, uint total_key,
		uint seedlen, unsigned int* seed_idx_dev, unsigned long* c1_off,
...
__global__ void pair_filtering3(uint sid, unsigned char* fP_dev, unsigned char* rP_dev, uint* fsid_dev, uint* rsid_dev,
    uint* fpos_dev, uint* rpos_dev, double* ftemp_dev, double* rtemp_dev, double* fenergy_dev, double* renergy_dev,
